...
def make_coco_transforms(image_set):
    ...
    if image_set == 'train':
        return T.Compose([
            ...
            # T.RandomApplyImgAnno(
            #     [T.ColorJitterImgAnno(0.3, 0.3, 0.3, 0.1)], p=0.5
            # ),
            # T.RandomGrayScaleImgAnno(p=0.2),
            # T.RandomApplyImgAnno(
            #     [T.GaussianBlurImgAnno([0.1, 1.5])], p=0.3
            # ),
            # #
            # T.RandomRotation(degrees=5),  # 增加随机旋转
