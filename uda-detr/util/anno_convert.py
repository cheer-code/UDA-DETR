...
if __name__ == "__main__":
    ...
    cityscapes_to_coco(
        ...
        src_path="D:\ZTT\domainData\cityscapes\gtFine/train",
        # des_path="annotations/cityscapes_train.json",
        des_path="D:\ZTT\domainData\cityscapes\coco_annotations/cityscapes_train_cocostyle.json",
    )
    cityscapes_to_coco(
        src_path="D:\ZTT\domainData\cityscapes\gtFine/val",
        des_path="D:\ZTT\domainData\cityscapes\coco_annotations/cityscapes_val_cocostyle.json",
    )
    # cityscapes_to_coco(
    #     src_path="gtFine/train",
    ...
    cityscapes_to_coco(
        src_path="D:\ZTT\domainData\cityscapes\gtFine/train",
        des_path="D:\ZTT\domainData\cityscapes_foggy\coco_annotations/foggy_cityscapes_train_cocostyle.json",
        foggy=True,
    )
    cityscapes_to_coco(
        src_path="D:\ZTT\domainData\cityscapes\gtFine/val",
        des_path="D:\ZTT\domainData\cityscapes_foggy\coco_annotations/foggy_cityscapes_val_cocostyle.json",
        foggy=True,
    )
